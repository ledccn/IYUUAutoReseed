...
使用IYUUAutoReseed自动辅种工具本身是非常安全的，IYUU自动辅种脚本，辅种时不会跟PT站点服务器产生任何关系，只是会把下载种子链接推送给下载器，由下载器去站点下载种子。理论上，任何站点、任何技术都无法检测你是否使用了IYUUAutoReseed。危险来自于包括但不限于以下几点：

第一：建议不要自己手动跳校验，任何因为跳校验ban号，别怪我没提醒，也请出事不要怪到IYUU的头上；

第二：官方首发种子的种子，IYUU也无法辅种的，如果因为你个人的作弊而被ban号，跟IYUU无关；

第三：使用本脚本造成的一切损失，与IYUU无关。如不接受此条款，请立刻删除已经下载的源码，不要使用IYUUAutoReseed。
